<?php
  ...
  */
  ...
  foreach ($colors as $color) {
    echo "<div style=\"margin: 0 60px; padding: 25px; color: #fff; text-transform: uppercase; text-shadow: 1px 1px 5px rgba(0,0,0,0.5); background-color: {$colors}\">{$color}</div>";
  }
  ...
  */
  ...
  foreach($emotions as $emotion) {
    if ($emotion = 'Angry') {
      ...
      echo "<p style=\"padding: 10px; background-color: #F6CCD1; color: #5F111A;\">{$emotions} {$animals[$duck]}</p>"
